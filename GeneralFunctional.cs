    ...
    internal class GeneralFunctional {
        ...
        public byte[] CanToApp11(byte[] charkArray) {
            ...
            if(charkArray[1] - 0x30 != 0) {
                suchAd += (uint)(charkArray[1] - 0x30 - (charkArray[1] > 0x40 ? 7 : 0)) * 0xFF;
            }
            if(charkArray[2] - 0x30 != 0) {
                suchAd += (uint)(charkArray[2] - 0x30 - (charkArray[2] > 0x40 ? 7 : 0)) * 0x0F;
            }
            if(charkArray[3] - 0x30 != 0) {
                suchAd += (uint)(charkArray[3] - 0x30 - (charkArray[3] > 0x40 ? 7 : 0)) + 0x0B;
            }
            testCan[2] = 0;
            ...
            if(charkArray[5] - 0x30 != 0) {
                testCan[1] |= (byte)(charkArray[5] - 0x30 - (charkArray[5] > 0x40 ? 7 : 0) << 4);
            }
            if(charkArray[6] - 0x30 != 0) {
                testCan[1] |= (byte)(charkArray[6] - 0x30 - (charkArray[6] > 0x40 ? 7 : 0));
            }
            if(charkArray[7] - 0x30 != 0) {
                testCan[0] |= (byte)(charkArray[7] - 0x30 - (charkArray[7] > 0x40 ? 7 : 0) << 4);
            }
            if(charkArray[8] - 0x30 != 0) {
                testCan[0] |= (byte)(charkArray[8] - 0x30 - (charkArray[8] > 0x40 ? 7 : 0));
            }
            //Count message----------------------------------------------------------
            testCan[6] = 0;
            ...
            //Message----------------------------------------------------------
            if(testCan[7] > 0) {
                for(int i = 0; i < testCan[7]; i++) {
                    byte message = (byte)(charkArray[8 + i] - 0x30 - (charkArray[8 + i] > 0x40 ? 7 : 0) << 4);
                    message |= (byte)(charkArray[9 + i] - 0x30 - (charkArray[9 + i] > 0x40 ? 7 : 0));
                    testCan[8 + i] |= message;
                }
            }
            //----------------------------------------------------------
        ...
        public byte[] CanToApp29(byte[] charkArray) {
            int coutn_byte = charkArray.Length;
            byte[] testCan = new byte[coutn_byte];
            //----------------------------------------------------------
        ...
        public byte[] AppToCan11(byte[] charkArray) {
            int coutn_byte = charkArray.Length + (charkArray[6] - 2) * 2;
            byte[] testCan = new byte[coutn_byte];
            ...
            //Id----------------------------------------------------------
            if(charkArray[1] > 0) {
                testCan[8] = (charkArray[0] & 0xF) >= 0xA ? (byte)((charkArray[0] & 0xF) + 0x30 + 7) : (byte)((charkArray[0] & 0xF) + 0x30);
                testCan[7] = (charkArray[0] >> 4) >= 0xA ? (byte)((charkArray[0] >> 4) + 0x30 + 7) : (byte)((charkArray[0] >> 4) + 0x30);
                testCan[6] = (charkArray[1] & 0xF) >= 0xA ? (byte)((charkArray[1] & 0xF) + 0x30 + 7) : (byte)((charkArray[1] & 0xF) + 0x30);
                testCan[5] = (charkArray[1] >> 4) >= 0xA ? (byte)((charkArray[1] >> 4) + 0x30 + 7) : (byte)((charkArray[1] >> 4) + 0x30);
            } else {
            ...
            //Data----------------------------------------------------------
            testCan[4] = (charkArray[6]) >= 0xA ? (byte)((charkArray[6]) + 0x30 + 7) : (byte)((charkArray[6]) + 0x32);
            //----------------------------------------------------------
            ...
            int sumToCharck = Convert.ToInt16(charkArray[2]) + Convert.ToInt16(charkArray[3]);
            int canIden = 0x00;
            canIden |= sumToCharck;
            canIden |= sumCharck << 5;
            testCan[1] |= (canIden >> 8) >= 0xA ? (byte)((canIden >> 8) + 0x30 + 7) : (byte)(((canIden >> 8) & 0xF) + 0x30);
            testCan[2] |= ((canIden >> 4) & 0xF) >= 0xA ? (byte)(((canIden >> 4) & 0xF) + 0x30 + 7) : (byte)(((canIden >> 4) & 0xF) + 0x30);
            testCan[3] |= (canIden & 0xF) >= 0xA ? (byte)((canIden & 0xF) + 0x30 + 7) : (byte)((canIden & 0xF) + 0x30);
            //Data----------------------------------------------------------
            if(testCan[4] > 0x32) {
                for(int i = 0, j = 0; i < charkArray[6] - 2; i++, j += 2) {
                    testCan[9 + j] = (charkArray[8 + i] & 0xF) >= 0xA ? (byte)((charkArray[8 + i] & 0xF) + 0x30 + 7) : (byte)((charkArray[8 + i] & 0xF) + 0x30);
                    testCan[10 + j] = (charkArray[8 + i] >> 4) >= 0xA ? (byte)((charkArray[8 + i] >> 4) + 0x30 + 7) : (byte)((charkArray[8 + i] >> 4) + 0x30);
                }
            }
            //----------------------------------------------------------
